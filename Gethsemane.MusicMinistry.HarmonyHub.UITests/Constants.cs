namespace Gethsemane.MusicMinistry.HarmonyHub.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "org.gethsemane.harmonyhub";
    public readonly static string AndroidAppName = "org.gethsemane.harmonyhub";
